...
export default function HomeBanner() {
  return (
    <div className="h-[700px] bg-cover bg-right lg:bg-top bg-[url(/img/home/banner-home.png)]">
      ...
      <div className="relative h-full flex flex-col justify-center px-6 lg:px-24 max-w-2xl">
        ...
        <p className="text-white/90 text-lg mb-8 font-light leading-relaxed">
          ...
          individual and organizations transforming their managers, leaders, and
          teams to become exceptional leaders.
        </p>
